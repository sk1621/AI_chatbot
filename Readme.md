...
* will show the summary of the given data. (what the column names tells about. how many numeircal colns, categorical colns,
  data types of each column, std, variance, percentiles like that).
* final one shows what are the graphs or charts we might use from this dataset. will show suggestions.

packages like 

* streamlit for UI. (doesnot work on api and also on DB...)
* used ollama LLM models
